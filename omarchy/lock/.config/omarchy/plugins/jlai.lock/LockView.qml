    ...
    BorderSurface {
      ...
      TextInput {
        ...
        Keys.onPressed: function(event) {
          ...
          // Cmd+A / Ctrl+A select all. The Cmd shim can't run on the lock
          // screen (Hyprland suppresses keybinds while a session lock is
          // active), so handle the raw Meta modifier here.
          if (event.key === Qt.Key_A && (event.modifiers & (Qt.MetaModifier | Qt.ControlModifier))) {
